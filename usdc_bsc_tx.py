...
bridge_contract_address = '0x6937a62f93a56D2AE9392Fa1649b830ca37F3ea4'
bridge_abi = [
    {
        "inputs": [
            {
...
# Адрес контракта токена USDC и ABI
...
amount = 1660444098731336109  # 1.6 токенов USDC (с учетом десятичных знаков)
